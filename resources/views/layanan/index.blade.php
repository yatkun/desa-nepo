...
@section('konten')
    <section class="">
        <div class="flex items-center justify-between">
            <h3 class="font-semibold text-heading">Daftar Layanan</h3>
            <a href="{{ route('layanan.create') }} "
                class="px-3 py-2 text-sm text-white bg-green-600 rounded hover:bg-green-700">Tambah Layanan</a>
        </div>
                                ...
                                @foreach ($layanan as $item)
                                    <tr>
                                        ...
                                        <td class="px-12 py-4 font-medium whitespace-nowrap">
                                            <a href="{{ url('layanan/edit') }}/{{ $item->id }}"
