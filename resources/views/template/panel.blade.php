            ...
            <ul class="mt-4">
                    ...
                    <ul class="mt-1 hidden group-[.selected]:block">
                        <li class="mb-1">
                            <a href="{{ route('visimisi') }}"
                                class="pl-12 {{ request()->is('profil/visi-misi*') ? 'active text-white group-[.selected]:bg-[#5B6AA1]' : '' }} text-sm flex items-center py-3 px-4 text-gray-300 hover:bg-[#5B6AA1] hover:text-gray-100 rounded-md  group-[.active]:text-white  group-[.selected]:text-gray-100">Visi
                                Misi</a>
                        </li>
                        <li class="mb-1">
                            <a href="{{ route('sejarah') }}"
                                class="pl-12 {{ request()->is('profil/sejarah*') ? 'active text-white group-[.selected]:bg-[#5B6AA1]' : '' }} text-sm flex items-center py-3 px-4 text-gray-300 hover:bg-[#5B6AA1] hover:text-gray-100 rounded-md  group-[.active]:text-white  group-[.selected]:text-gray-100">Sejarah</a>
                        </li>
                    </ul>
                </li>
                <li class="mb-1 group {{ request()->is('berita*') ? 'active selected' : '' }}">
                    ...
                    <ul class="mt-1 hidden group-[.selected]:block">
                        <li class="mb-1">
                            <a href="{{ route('berita') }}"
                                class="pl-12 {{ request()->is('berita*') ? 'active text-white group-[.selected]:bg-[#5B6AA1]' : '' }} text-sm flex items-center py-3 px-4 text-gray-300 hover:bg-[#5B6AA1] hover:text-gray-100 rounded-md  group-[.active]:text-white  group-[.selected]:text-gray-100">Daftar
                                Berita</a>
                        </li>
                    ...
                    <ul class="mt-1 hidden group-[.selected]:block">
                        <li class="mb-1">
                            <a href="{{ route('layanan') }}"
                                class="pl-12 {{ request()->is('layanan*') ? 'active text-white group-[.selected]:bg-[#5B6AA1]' : '' }} text-sm flex items-center py-3 px-4 text-gray-300 hover:bg-[#5B6AA1] hover:text-gray-100 rounded-md  group-[.active]:text-white  group-[.selected]:text-gray-100">Daftar
                                Layanan</a>
                        </li>
                    ...
                    <ul class="mt-1 hidden group-[.selected]:block">
                        <li class="mb-1">
                            <a href="{{ route('pengumuman') }}"
                                class="pl-12 {{ request()->is('pengumuman*') ? 'active text-white group-[.selected]:bg-[#5B6AA1]' : '' }} text-sm flex items-center py-3 px-4 text-gray-300 hover:bg-[#5B6AA1] hover:text-gray-100 rounded-md  group-[.active]:text-white  group-[.selected]:text-gray-100">Daftar
                                Pengumuman</a>
                        </li>
                ...
                <li class="mb-1 group {{ request()->is('admin*') ? 'active selected' : '' }}">
                    ...
                    <ul class="mt-1 hidden group-[.selected]:block">
                        <li class="mb-1">
                            <a href="{{ route('user') }}"
                                class="pl-12 {{ request()->is('admin*') ? 'active text-white group-[.selected]:bg-[#5B6AA1]' : '' }} text-sm flex items-center py-3 px-4 text-gray-300 hover:bg-[#5B6AA1] hover:text-gray-100 rounded-md  group-[.active]:text-white  group-[.selected]:text-gray-100">Daftar
                                Admin</a>
                        </li>
