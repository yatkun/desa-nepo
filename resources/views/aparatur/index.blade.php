...
@section('konten')
    <section class="">
        <div class="flex items-center justify-between">
            <h3 class="font-semibold text-heading">Daftar Aparatur Desa</h3>
            <a href="{{ route('aparatur.tambah') }} "
                class="px-3 py-2 text-sm text-white bg-green-600 rounded hover:bg-green-700">Tambah Aparatur</a>
        </div>
                                ...
                                @foreach ($post as $item)
                                    <tr>
                                        ...
                                        <td class="px-12 py-4 font-medium whitespace-nowrap">
                                            <a href="{{ url('aparatur-desa/edit') }}/{{ $item->id }}"
                                        ...
                                        <td class="px-4 py-4 whitespace-nowrap">
                                            <img src="{{ asset('storage/' . $item->foto) }}"
                                                class="object-cover w-16 rounded-md">
                                        </td>
