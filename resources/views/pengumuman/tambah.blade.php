...
@section('konten')
    <h3 class="mb-3 font-semibold text-heading">Tambah Pengumuman</h3>
            ...
            <div class="mb-5">
                <div>
                    ...
                    <input autofocus class="w-full p-2 mb-4 bg-white border border-gray-300 outline-none title"
                        spellcheck="false" placeholder="Masukkan judul pengumuman" id="judul" name="judul" type="text">
                </div>
                <div>
...
@section('script')
    <script>
        ...
        judul.addEventListener('change', function() {
            fetch('/pengumuman/tambah/checkSlug?judul=' + judul.value)
