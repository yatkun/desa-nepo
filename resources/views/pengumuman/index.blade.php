...
@section('konten')
    <section class="">
        <div class="flex items-center justify-between">
            <h3 class="font-semibold text-heading">Daftar Pengumuman</h3>
            <a href="{{ route('pengumuman.create') }} "
                class="px-3 py-2 text-sm text-white bg-green-600 rounded hover:bg-green-700">Tambah Pengumuman</a>
        </div>
                                ...
                                @foreach ($pengumuman as $item)
                                    <tr>
                                        ...
                                        <td class="px-12 py-4 font-medium whitespace-nowrap">
                                            <a href="{{ url('pengumuman/edit') }}/{{ $item->id }}"
